...
public class Cont_Detail_Part {
    ...
    static final int TB = 3; //Textbook 교과서
    static final int subject_codes[] = {LP,IV,TP,TB};
    static int favorite_subjects[] = {LP,IV,TP,TB};;// Optional.관심 과목 추가. 마땅히 없으면 subject_code[] 와 같은 값을 주면 됨.
    ...
    public static void init_informations() {
        ...
        Cont_2nd_03_Textbook.content_installing(TB);
    }
    /* TODO [END] */
}
